...
export default async function generatePackageJson(name = '', dest = '', options = {}) {
  ...
  const devDependencies = [
          {name: '@babel/core', version: '^7.13.14'},
          {name: '@babel/preset-env', version: '^7.13.12'},
          {name: '@babel/register', version: '^7.13.14'},
  ...
  if (options.conventionalCommits) {
    devDependencies.push(
      {name: '@commitlint/cli', version: '^12.1.1'},
      {name: '@commitlint/config-conventional', version: '^12.1.1'},
