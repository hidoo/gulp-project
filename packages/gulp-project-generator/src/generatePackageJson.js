...
export default async function generatePackageJson(name = '', dest = '', options = {}) {
  ...
  const devDependencies = [
          {name: '@babel/core', version: '^7.13.13'},
          {name: '@babel/preset-env', version: '^7.13.12'},
          {name: '@babel/register', version: '^7.13.8'},
          ...
          {name: 'husky', version: '^4.2.5'},
          {name: 'lint-staged', version: '^10.2.2'},
  ...
  if (options.server) {
    devDependencies.push(
      {name: '@hidoo/express-engine-handlebars', version: '^0.7.0'},
  ...
  if (options.conventionalCommits) {
    devDependencies.push(
      {name: '@commitlint/cli', version: '^12.0.1'},
      {name: '@commitlint/config-conventional', version: '^12.0.1'},
