...
export default async function generatePackageJson(name = '', dest = '', options = {}) {
  ...
  const devDependencies = [
          ...
          {name: 'eslint', version: '^5.15.3'},
          {name: 'gulp', version: '^4.0.0'},
          {name: 'husky', version: '^2.2.0'},
          {name: 'lint-staged', version: '^8.1.6'},
  ...
  if (options.conventionalCommits) {
    devDependencies.push(
      {name: '@commitlint/cli', version: '^7.6.0'},
      {name: '@commitlint/config-conventional', version: '^7.6.0'},
