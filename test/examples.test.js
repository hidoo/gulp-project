  ...
  describe('single-device', () => {
    ...
    it('should generate files to ./public directory.', async () => {
      ...
      await new Promise((resolve, reject) =>
        childProcess.exec('npm run dev:build', (error) => {
          if (error) {
            reject(error);
          } else {
            resolve();
    ...
    it('should pass test.', async () => {
      await new Promise((resolve, reject) =>
        childProcess.execFile('npm', ['test'], (error, stdout) => {
          if (error) {
  ...
  describe('multi-device', () => {
    ...
    it('should generate files to ./public directory.', async () => {
      ...
      assert.deepEqual(actual, [
        ...
        '/mobile/styleguide/kss-assets/css/main.min.css',
        '/mobile/styleguide/kss-assets/css/main.min.css.br',
        '/mobile/styleguide/kss-assets/css/main.min.css.gz',
        '/mobile/styleguide/kss-assets/images/favicon.ico',
        '/mobile/styleguide/kss-assets/images/favicon.svg',
        '/mobile/styleguide/kss-assets/images/touchicon.png',
        '/mobile/styleguide/kss-assets/js/main.js',
        '/mobile/styleguide/kss-assets/js/main.js.br',
        '/mobile/styleguide/kss-assets/js/main.js.gz',
